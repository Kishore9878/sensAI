...
const InterviewTypeSelectionPage = () => {
  ...
  const handleSelect = (typeId) => {
    navigate(`/interview/prep?type=${typeId}`);
  };
  ...
  const interviewTypes = [
    ...
    },
    {
      ...
      description: 'Review broad career-focused questions, resume discussions, strengths and weaknesses, professional goals, and general industry awareness.',
      icon: <HelpCircle className="w-5 h-5 text-sky-400 group-hover:text-sky-300 transition-colors" />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-black text-foreground flex flex-col font-sans selection:bg-indigo-500/20">
      ...
      {/* Main Container */}
      <main className="flex-1 container mx-auto px-6 py-10 relative z-10 space-y-8 max-w-5xl">
