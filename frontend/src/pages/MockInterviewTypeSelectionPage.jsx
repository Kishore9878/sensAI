...
const MockInterviewTypeSelectionPage = () => {
  ...
  const interviewTypes = [
    ...
    {
      id: 'resume',
      name: 'Resume-Based Mock Interview',
    ...
    {
      id: 'core_subjects',
      name: 'Core Subjects Mock Interview',
      ...
      <main className="flex-1 container mx-auto px-6 py-8 relative z-10 space-y-8">
        ...
        <div className="space-y-2 max-w-2xl">
          ...
          <p className="text-xs text-neutral-400 leading-relaxed">
            Choose the specific interview assessment style you want to simulate. The AI interviewer will perform a verbal/text mock interview with you.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-3.5">
                ...
                <div className="space-y-0.5">
                  <h3 className="text-[15px] font-bold text-white group-hover:text-purple-500 transition-colors duration-200">
                    {type.name}
                  </h3>
